...
The inner end of the card with the power connector has two screw holes that are convenient for a 3D printed shroud to sit on and attach a blower fan to.

![K200 heatsink end](./heatsink.jpg)
...
My setup looks like this with the blower, duct, and molex PWM splitter. Note that the power plug was a very tight fit and I needed to break off one of the top clips to fit with the card geometry:

![K200 cooling setup](./cooling.jpg)
